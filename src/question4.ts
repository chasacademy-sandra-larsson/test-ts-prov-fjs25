// 4. (2p) Skriv en funktion getAuthorsByFullname som tar en array 
// med författare och returnerar en ny array med författarnas 
// fullständiga namn, för och efternamn.
// Använd map
...
const authors = [
  ...
  function getAuthorsByFullname(authors: Author[]) {
    // Din kod här
      return authors.map(author => `${author.first} ${author.last}`);
